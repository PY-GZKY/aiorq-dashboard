      ...
      >
        <el-card class="box-card">
          ...
          <el-descriptions title="用户信息" :column="1" border>
            <el-descriptions-item label="redis_version">{{
              items.redis_version
            }}</el-descriptions-item>
            <el-descriptions-item label="os">{{
              items.os
            }}</el-descriptions-item>
            <el-descriptions-item label="tcp_port">
              {{ items.tcp_port }}
            </el-descriptions-item>

            <el-descriptions-item label="uptime_in_seconds">
              {{ items.uptime_in_seconds }}
            </el-descriptions-item>
            <el-descriptions-item label="uptime_in_days">
              {{ items.uptime_in_days }}
            </el-descriptions-item>

            <el-descriptions-item label="used_memory_human">
              <el-tag size="small">{{ items.used_memory_human }}</el-tag>
            </el-descriptions-item>
          </el-descriptions>
